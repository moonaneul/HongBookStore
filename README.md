...
- 팀 의사결정 시트에서 거래 장소 활용, 위치 등록 방식, 장소 사진 수, 경로 안내, 챗봇 입력 방식 등 제품 정책 논의에 직접 참여
- 화면 구조와 사용자 흐름 설계
- Figma 기반 화면 설계
...
추가로 보관 중인 프로젝트 시트 모음에서는 **기능 명세서 · 사용자 중심 요구사항 정의서 · 화면 정의서 · 권한표 · Use Case 모음**까지 확인했으며, 의사결정 시트의 `문하늘` 열에 여러 안건에 대한 직접 의견 기록이 남아 있습니다.
